...
$ver = 'NATS_STREAMING_SERVER 0.25.5'.Split(' ')[1]
...
docker build --tag nats-streaming:0.25.5-windowsservercore-1809 .
...
docker build --tag nats-streaming:0.25.5-nanoserver-1809 .
if ($LASTEXITCODE -ne 0) {
    exit 1
}
